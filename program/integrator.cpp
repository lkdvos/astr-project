...
void RK41(const double hmax, Constellation& a) {
  double h = hstep(hmax, a);
...
void Verlet1(const double hmax, Constellation& a, vector<phaseVec>& driver) {
  double h = hstep(hmax, a);
...
void FR1(const double hmax, Constellation& a) {
  double h = hstep(hmax, a);
  //step 1
